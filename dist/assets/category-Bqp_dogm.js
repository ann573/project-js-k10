import{g as S}from"./service-Ccry4lSF.js";import{g as E}from"./utils-ev9IYk3T.js";const M=document.querySelector(".path"),g=document.querySelector(".increase"),m=document.querySelector(".desc"),q=document.querySelector(".fillRating"),T=document.querySelector("#number_product"),f=document.querySelector(".main"),y=document.querySelector(".gallery"),b=document.querySelector(".list"),C=document.querySelector("input[name='search_product']");let l=!1,d=!1,p=!1,o=1,k;(async()=>{const e=await S(`products/category/${E("category")}`);console.log(e),T.textContent=e.products.length,H(),D(e),F(e),h(e),y.addEventListener("click",()=>h(e)),b.addEventListener("click",()=>h(e))})();const h=e=>{C.value="",l=!l,y.classList.toggle("text-[#292828]",l),b.classList.toggle("text-[#807b7b]",l),y.classList.toggle("text-[#807b7b]",!l),b.classList.toggle("text-[#292828]",!l),p?L(e.products):d?x(e.products):r(o,e.products)};C.addEventListener("input",function(e){const s=data.products.filter(t=>t.title.toLowerCase().includes(e.target.value.toLowerCase()));r(o,s)});function H(){M.innerHTML=`
      ...
      `}function D(e){g.addEventListener("click",()=>$(e,g)),m.addEventListener("click",()=>$(e,m))}function $(e,s){s.children[0].children[0].style.display==="block"?s.children[0].children[0].style.display="none":(g.children[0].children[0].style.display="none",m.children[0].children[0].style.display="none",s.children[0].children[0].style.display="block"),s.classList[0]==="increase"?(d=!d,p&&(p=!1),d?x(e.products):r(o,e.products)):(p=!p,d&&(d=!1),p?L(e.products):r(o,e.products))}function x(e){const s=[...e];console.log(s),s.sort((t,n)=>t.price-n.price),r(o,s)}function L(e){const s=[...e];s.sort((t,n)=>n.price-t.price),r(o,s)}function F(e){for(let t=1;t<=5;t++){let n="";const i=document.createElement("div");i.classList.add("check_star","cursor-pointer","flex","items-center","mb-2","w-max","select-none");const a=`
